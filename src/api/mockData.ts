...
export const serviceCatalog: ServiceDefinition[] = [
  ...
  },
  {
    ...
    advisor: '운월선생',
    subtitle: '지금부터 앞으로 이어질 상승 구간과 조심할 구간을 또렷하게 읽는 리포트',
    teaser: '올해와 내년 사이 흐름 변화를 중심으로 상승 타이밍을 보여줍니다.',
    description:
      '전체적인 사주보다 조금 더 시기감 있게 보고 싶을 때 선택하기 좋은 리포트입니다. 일과 관계, 재정에서 어떤 국면이 열리는지 카드뉴스처럼 빠르게 확인하고, 길게 읽고 싶은 분을 위해 본문형 분석도 함께 제공합니다.',
    price: '59,000원',
    accent: '#c78f62',
    theme: 'newyear',
    heroTag: 'LIFE FLOW',
    badge: '흐름 집중',
    spotlight: '앞으로의 변화 시기를 미리 보고 싶을 때 선택하는 흐름형 분석',
